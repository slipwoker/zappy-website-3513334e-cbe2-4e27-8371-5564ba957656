...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        const validators = {
            ...
            text: (value, input) => {
                if (input.required && !value.trim()) return 'This field is required';
                if (value.trim() && value.trim().length < 2) return 'Must be at least 2 characters';
                return null;
            },
            textarea: (value, input) => {
                if (input.required && !value.trim()) return 'This field is required';
                if (value.trim() && value.trim().length < 10) return 'Must be at least 10 characters';
                return null;
            }
        };
    ...
    if (animatedElements.length > 0) {
        ...
        // Handle RTL for fade-in-left/right
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '3513334e-cbe2-4e27-8371-5564ba957656',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '3513334e-cbe2-4e27-8371-5564ba957656';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '3513334e-cbe2-4e27-8371-5564ba957656';
